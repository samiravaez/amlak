...
class CustomerRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'residence_change_reason' => 'nullable|max:255',
            ...
            'experience_company'=> 'nullable|max:100',
            'children_count' => 'nullable|min:1|max:100|numeric',
            'fund_value'=> 'nullable|max:255',
            'phone' => 'nullable|max:11|regex:/(0)[0-9]{10}/',
            'mobile_number' => 'nullable|max:11|regex:/(09)[0-9]{9}/',
