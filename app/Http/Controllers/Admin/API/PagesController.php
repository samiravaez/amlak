...
class PagesController extends PostsController
{
    ...
    public static $success_touch = 'عملیات به روز رسانی تاریخ برگه موردنظر ناموفق بود.';
    public static $failure_create_post = 'عملیات ایجاد برگه جدید ناموفق بود.';
    public static $failure_edit_post = 'عملیات به روز رسانی برگه موردنظر ناموفق بود.';
    public static $failure_delete_post = 'عملیات حذف برگه موردنظر ناموفق بود.';
    public static $failure_touch = 'عملیات به روز رسانی تاریخ برگه موردنظر ناموفق بود.';
    public static $failure_type = 'آیتم انتخاب شده از نوع برگه نیست.';
