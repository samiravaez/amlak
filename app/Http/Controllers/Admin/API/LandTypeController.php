...
class LandTypeController extends CategoriesController
{
    ...
    public static $failure_delete_post = 'عملیات حذف نوع ملک موردنظر ناموفق بود.';
    public static $failure_create_post = 'عملیات ایجاد نوع ملک جدید ناموفق بود.';
    public static $failure_select_post = 'نوع ملک موردنظر یافت نشد.';
    public static $failure_edit_post = 'عملیات به روز رسانی نوع ملک موردنظر ناموفق بود.';
