...
class AddsController extends PostsController
{
    ...
    public static $list_view='admin.list.adds';
    public static $edit_view='admin.edit.adds';
    ...
    public static $success_create_post='آگهی جدید با موفقیت ثبت شد.';
    ...
    public static $success_recursion_post='آگهی شما با موفقیت بازگردانی شد.';
    public static $success_reject_post='آگهی شما با موفقیت رد شد.';
    public static $success_confirm_post='آگهی شما با موفقیت تأیید شد.';
    public static $success_reset_confirm_post='آگهی شما با موفقیت به حالت اولیه بازگردانده شد.';
...
//    }
    ...
    public function index()
    {
        ...
        return view(static::$list_view,compact($compact))->withShortcodes()->with(['page_title' => static::$items_list]);
    }
...
//        }
    ...
    public function filter_all_adds(Request $request)
    {
        ...
        return view(static::$list_view,compact('posts','all_posts','expressions','ostans','land_types','transactions','features'))->withShortcodes()->with(['page_title' => static::$items_list]);
    }
    ...
    public function filter_my_adds(Request $request){
        ...
        return view(static::$list_view,compact('posts','all_posts','expressions','ostans','land_types','transactions','features'))->withShortcodes()->with(['page_title' => static::$items_my_list]);
    }
...
//        return $posts;
    ...
    public function my_adds()
    {
        ...
        return view(static::$list_view,compact($compact))->withShortcodes()->with(['page_title' => static::$items_my_list]);
    }
    ...
    public function waiting_adds()
    {
        ...
        $expressions=array(
            'breadcrumb_title'=>'آگهی های تأیید نشده',
            'posts_edit_route'=>static::$posts_edit_route,
            'posts_delete_route'=>static::$posts_delete_route,
        );
        ...
        return view(static::$list_view,compact($compact))->withShortcodes()->with(['page_title' => 'آگهی های تأیید نشده']);
    }
    ...
    public function show_trash_adds()
    {
        if (Auth::user()->can('adds_management')) {
            ...
            return view(static::$list_view, compact('posts', 'adds', 'expressions', 'ostans', 'land_types', 'transactions', 'features','users'))->withShortcodes()->with(['page_title' => static::$trash_item]);
        }else{
...
//                $filter=Post::where('post_type', static::$post_type)->orderBy('updated_at','desc');
    ...
    public function show_archive_adds(Request $request){
        ...
        if (Auth::user()->can('adds_management')){
            ...
            $compact=['posts','all_posts','adds','expressions','ostans','land_types','transactions','features','users'];
        }else{
            $compact=['posts','all_posts','adds','expressions','ostans','land_types','transactions','features'];
        }

        return view(static::$list_view,compact($compact))->withShortcodes()->with(['page_title' => static::$archive_item]);
    }
    ...
    public function archive_adds(Request $request, $post_id)
    {
    ...
    public function trash_adds(Request $request, $post_id)
    {
        if (static::trash($post_id))
            return redirect()->route(static::$posts_list_route)->with('success', static::$success_trash_post);
        return redirect()->back();
    }
    ...
    public function recursion_adds(Request $request, $post_id)
    {
        if (static::recursion($post_id))
            return redirect()->route(static::$posts_list_route)->with('success', static::$success_recursion_post);
        return redirect()->back();
    }
    ...
    public function reject_adds(Request $request, $post_id)
    {
        if (static::reject($post_id))
            return redirect()->route(static::$posts_list_route)->with('success', static::$success_reject_post);
        return redirect()->back();
    }
    ...
    public function confirm_adds(Request $request, $post_id)
    {
        if (static::confirm($post_id))
            return redirect()->route(static::$posts_list_route)->with('success', static::$success_confirm_post);
        return redirect()->back();
    }
    ...
    public function reset_confirm_adds(Request $request, $post_id)
    {
        if (static::reset_confirm($post_id))
            return redirect()->route(static::$posts_list_route)->with('success', static::$success_reset_confirm_post);
        return redirect()->back();
    }
...
EDT;
    ...
    public function show_dashboard(Request $request)
    {
        ...
        return view('admin.dashboard',compact($compact))->with(['page_title'=>'داشبورد']);
    }
    ...
    public function get_adds_details(Request $request)
    {
        if($request->has('adds')){
            ...
            if($adds){
                return response()->json(array('name' => $adds->name, 'info' => array(
                    array(
                        'label' => 'سال ساخت',
