...
<div class="form-wrapper">
    ...
    <form action="<?php echo e(route('user.register')); ?>" method="post">
        ...
        <a href="<?php echo e(route('user.login')); ?>" class="btn btn-outline-light btn-sm">وارد حساب کاربری خود شوید!</a>
    </form>
    <!-- ./ form -->
</div>
...
<?php /**PATH C:\Users\SamiraVz\Desktop\amlak\resources\views/auth/registerWithUserNameAndPass.blade.php ENDPATH**/ ?>