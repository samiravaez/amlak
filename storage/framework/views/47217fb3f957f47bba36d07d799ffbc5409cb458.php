...
<head>
    <meta charset="UTF-8">
    <title><?php echo e(isset($page_title)?$page_title:'خانه'); ?></title>
    <?php $root=url('');?>
...
<body class="sticky-footer">
    ...
    <div id="main">
        <?php echo $__env->make('admin.panel_header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <main class="main-content">
            <?php echo $__env->yieldContent('content'); ?>
            <?php echo $__env->make('admin.panel_footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </main>
    </div>
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade show active" id="select12-tab" role="tabpanel" aria-labelledby="profile-tab">
                        <div class="row py-2" id="checkedMediaForm">
                            <?php echo $__env->make("admin.lib_files", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                    </div>
    ...
    <script>
        ...
        $('.add-to-menu.add-post-to-menu').click(function (e){
            ...
            $.ajax({
                type:'post',
                url:"<?php echo e(route('ajax.addPostsToMenu')); ?>",
                data:{selects},
                dataType:'json',
        ...
        $('.add-to-menu.add-term-to-menu').click(function (e){
            ...
            $.ajax({
                type:'post',
                url:"<?php echo e(route('ajax.addTermsToMenu')); ?>",
                data:{selects},
                dataType:'json',
                success:function (response){
                    if (response.length>0){
        ...
        Dropzone.options.uploadFile={
            ...
            uploadMultiple:true,
            acceptedFiles:'image/*',
            url: "<?php echo e(route('ajax.upload.image')); ?>",
            headers:{
        ...
        $('#tabtarh-lib').on('show.bs.modal',function (e){
            if (e.relatedTarget){
                ...
                if(!show_files){
                    ...
                    $.ajax({
                        type:'get',
                        url:"<?php echo e(route('admin.ajaxGetLibFiles')); ?>",
                        dataType:'json',
                        data:{page:page},
                        success:function (response){
                            if(response){
        ...
        $('.card-body').on('click','.download-item .fa-times',function (){
            ...
            header.find('img').each(function (){
                src.push($(this).attr('src').replace("<?php echo e(UPLOAD_ROOT); ?>",''))
            })
        ...
        $('.add-list-item').click(function (){
            ...
            $.ajax({
                type:'post',
                url:"<?php echo e(route('ajax.add.listItemOption')); ?>",
        ...
        $('.add-list-item-post-meta').click(function (){
            ...
            $.ajax({
                type:'post',
                url:"<?php echo e(route('ajax.add.listItemOptionToPostMeta')); ?>",
        ...
        $(document).on('submit','#reply-comment-form',function (e){
            ...
            $.ajax({
                type:'get',
                url:"<?php echo e(route('admin.comment.reply')); ?>",
                data:form.serialize(),
                dataType:'json',
                success:function (response){
                    var html='<tr>'
        ...
        $(document).on('click','.edit_comment',function (e){
            ...
            $.ajax({
                type:'get',
                url:"<?php echo e(route('admin.comment.get')); ?>",
        ...
        $(document).on('submit','#edit-comment-form',function (e){
            ...
            $.ajax({
                type:'get',
                url:"<?php echo e(route('admin.comment.edit')); ?>",
                data:form.serialize(),
                dataType:'json',
                success:function (response){
        ...
        $('#add-user-jobs').click(function (e){
            ...
            $.ajax({
                type:'get',
                url:"<?php echo e(route('admin.add_user_job')); ?>",
                data:{num:num},
                success:function (response){
        ...
        $(document).on('change','.ostan-change',function (){
            ...
            $.ajax({
                type:'get',
                url:"<?php echo e(route('admin.ajax_get_shahrestans')); ?>",
                data:{ostan:ostan},
                dataType:'json',
                success:function (response){
                    if (response){
        ...
        $(document).on('change','.shahrestan-change',function (){
            ...
            $.ajax({
                type:'get',
                url:"<?php echo e(route('admin.ajax_get_manategh')); ?>",
        ...
        $(document).on('change','.mantaghe-change',function (){
            ...
            $.ajax({
                type:'get',
                url:"<?php echo e(route('admin.ajax_get_bakhshs')); ?>",
        ...
        $('#add-user-regions').click(function (e){
            ...
            $.ajax({
                type:'get',
                url:"<?php echo e(route('admin.ajax_getOstans')); ?>",
                dataType:'json',
                success:function (response){
    ...
    <script>
        ...
        $(document).on('click','.save-new-menu',function (e){
            ...
            $.ajax({
                type:'post',
                url:"<?php echo e(route('admin.menus.storeMenu')); ?>",
        ...
        $(document).on('click','.edit-menu',function (e){
            ...
            $.ajax({
                type:'post',
                url:"<?php echo e(route('admin.menus.updateMenu')); ?>",
        ...
        $(document).on('click','.remove-menu',function (e){
            ...
            $.ajax({
                type:'post',
                url:"<?php echo e(route('admin.menus.deleteMenu')); ?>",
                data:{curr:curr},
                dataType:'json',
                success:function (response){
                    if (response.error){
            ...
            if (elm.is('[data-adds]')){
                ...
                swal({
                    ...
                    if (isConfirm) {
                        $.ajax({
                            type:'post',
                            url:"<?php echo e(route('admin.ajaxArchiveAdds')); ?>",
                            data:{id:id},
                            success:function (response){
                                if (response.success){
            ...
            if (elm.is('[data-adds]')){
                ...
                swal({
                    ...
                    if (isConfirm) {
                        $.ajax({
                            type:'post',
                            url:"<?php echo e(route('admin.ajaxTrashAdds')); ?>",
                            data:{id:id},
                            success:function (response){
                                if (response.success){
                                    swal(response.message,{icon:'success',timer:1000,buttons:false})
            ...
            if (elm.is('[data-adds]')){
                ...
                swal({
                    ...
                    if (isConfirm) {
                        $.ajax({
                            type:'post',
                            url:"<?php echo e(route('admin.ajaxRecursionAdds')); ?>",
                            data:{id:id},
                            success:function (response){
                                if (response.success){
                                    swal(response.message,{icon:'success',timer:1000,buttons:false})
            ...
            if (elm.is('[data-adds]')){
                ...
                swal({
                    ...
                    if (isConfirm) {
                        $.ajax({
                            type:'post',
                            url:"<?php echo e(route('admin.ajaxDeleteAdds')); ?>",
                            data:{id:id},
                            success:function (response){
                                if (response.success){
                                    swal(response.message,{icon:'success',timer:1000,buttons:false})
            ...
            if (elm.is('[data-adds]')) {
                ...
                swal({
                    ...
                    if (result !== null) {
                        $.ajax({
                            type: 'post',
                            url: "<?php echo e(route('admin.ajaxRejectAdds')); ?>",
        ...
        $(document).on('click','.confirm-request.confirm',function (e){
            ...
            if (elm.is('[data-adds]')){
                ...
                $.ajax({
                    type:'post',
                    url:"<?php echo e(route('admin.ajaxConfirmAdds')); ?>",
                    data:{id:id},
                    dataType:'json',
                    success:function (response){
                        if (response.success){
        ...
        $(document).on('click','.confirm-request.reset',function (e){
            ...
            if (elm.is('[data-adds]')){
                ...
                $.ajax({
                    type:'post',
                    url:"<?php echo e(route('admin.ajaxResetConfirmAdds')); ?>",
                    data:{id:id},
                    dataType:'json',
                    success:function (response){
                        if (response.success){
        ...
        $(document).on('change','select.relate-terms',function (e){
            ...
            $.ajax({
                ...
                data:data,
                dataType:'json',
                url:"<?php echo e(route('admin.getRelatedTerms')); ?>",
                success:function (response){
                    if(response.success){
        ...
        $(document).on('change','select.related-crm-terms',function (e){
            ...
            $.ajax({
                ...
                data:data,
                dataType:'json',
                url:"<?php echo e(route('admin.getRelatedCrmTerms')); ?>",
                success:function (response){
                    if(response.success){
                        relate.html(response.response)
                        $('.select2').select2()
        ...
        $('.transaction-change').change(function (){
            ...
            $.ajax({
                type:'get',
                url:'<?php echo e(route('land_types_list')); ?>',
                data:data,
                success:function (response){
                    if(response){
...
<?php /**PATH C:\Users\SamiraVz\Desktop\amlak\resources\views/admin/main.blade.php ENDPATH**/ ?>