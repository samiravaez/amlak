...
const TypesOfProperty = ({ match }) => {
  ...
  return (
    <Suspense fallback={<div className="loading" />}>
      <Row>
        <Colxx xss="12">
          <Breadcrumb heading={"myproperty"} match={match} />
        ...
        <Colxx md={12}>
          <Card>
            <CardHeader id="mainhead" onClick={secToggle} className="Bold">افزودن نوع ملک<i className='simple-icon-arrow-down ml-3 Bold'></i></CardHeader>
            <Separator />
