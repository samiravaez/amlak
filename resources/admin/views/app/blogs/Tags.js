  ...
  return (
    <>
      <Suspense fallback={<div className={'loading'} />}>
        <Row>
          <Colxx xss="12">
            <Breadcrumb heading={"menu.blog.tag.list"} match={match} />
        ...
        <Modal isOpen={modal} toggle={toggle}>
          <ModalHeader toggle={toggle}>افزودن برچسب</ModalHeader>
          ...
          <Formik enableReinitialize initialValues={initialValues} onSubmit={onSubmit}>
            {({ errors, touched, setFieldValue, setFieldTouched, values }) => (
              <Form>
                ...
                <ModalFooter>
                  <Button color="primary" type="submit" onClick={toggle}>افزودن برچسب</Button>{' '}
