...
const CrmList = ({match}) => {
    ...
    //   {
    //     id: 915,
    //     Registrar: <><div className="registrar">
    //       <p>پدرام پرتو</p>
    ...
    const fetchData = React.useCallback(async ({pageSize, pageIndex}) => {
            await axios.get(`${adminPathApi}/crm/customers?page=${pageIndex + 1}&per_page=${pageSize}`)
                .then((res) => {
    ...
    return (
        <Suspense fallback={<div className={'loading'}/>}>
            <Row>
                <Colxx xss="12">
                    <Breadcrumb heading={"menu.crm.list"} match={match}/>
            ...
            {/* <Modal
        isOpen={notApproveModal}
      >
        <ModalHeader>
          رد فروشگاه
        </ModalHeader>
        <Formik initialValues={{ type: 'deny_shop' }} onSubmit={handleModalNotApproveSubmit}>
          <Form>
            <ModalBody>
              <FormGroup>
