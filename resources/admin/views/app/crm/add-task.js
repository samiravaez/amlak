                                    ...
                                    {({errors, touched, setFieldValue, setFieldTouched, values}) => (
                                        <Form>
                                            <Row form>
                                                <Col md={6}>
                                                    <FormGroup>
                                                        <Label><span id="redspan">*</span>ساعت شروع :</Label>
                                                ...
                                                <Col md={6}>
                                                    <FormGroup>
                                                        <Label><span id="redspan">*</span>ساعت پایان :</Label>
                                                        <Field id="shadow" className="form-control" type="text"
                                            ...
                                            <Row form>
                                                <Col md={6}>
                                                    <FormGroup>
                                                        <Label><span id="redspan">*</span>نرخ پیشرفت :</Label>
                                                        <Field id="shadow" className="form-control" type="text"
                                                               name={"progress_rate"} required="required"/>
                                                        {errors.progress_rate && touched.progress_rate && (
                                                            <div className="invalid-feedback d-block">
                                                                {errors.progress_rate}
                                                            </div>
                                                        )}
                                                    </FormGroup>
                                                </Col>
