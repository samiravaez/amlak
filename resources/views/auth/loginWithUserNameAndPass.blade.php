...
<div class="form-wrapper">
    ...
    <form action="" method="post">
        ...
        <div class="form-group">
            <input type="email" name="email" class="form-control text-left" placeholder="ایمیل" dir="ltr" required="" autofocus="" {{ old('email') }}>
        </div>
        <div class="form-group position-relative">
            <input type="password" name="password" id="password-field" class="form-control text-left" placeholder="رمز عبور" dir="ltr" required="" {{ old('password') }}>
        ...
        <div class="form-group text-left d-sm-flex justify-content-between mb-4">
            ...
            <a href="{{route('login.phone')}}" class="line-height-28">ورود با شماره تلفن</a>
        </div>
